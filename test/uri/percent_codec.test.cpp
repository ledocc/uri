...
BOOST_AUTO_TEST_CASE( decode_string_iterator )
{
    ...
    uri::percent::decode( std::begin( encodedString ), std::end( encodedString ), std::back_inserter( decodedString ) );
...
BOOST_AUTO_TEST_CASE( decode_string )
{
    ...
    BOOST_TEST( "hello world, nice day ?" == uri::percent::decode( encodedString ) );
}
...
BOOST_AUTO_TEST_CASE( encode_string )
{
    ...
    uri::percent::encode( std::begin( decodedString ), std::end( decodedString ), std::back_inserter( encodedString ) );
